...
file2_path = 'genomes/GCF_036711695.1_CSIRO_AGI_Zmor_V1_protein.faa'  # Replace with the path to your first file
file1_path = 'ZM_BDFB_compRuns1/augustus.hints.aa/homologs_awk.txt'  # Replace with the path to your second file
output_file_path = 'HomologNamesZM.txt'  # Replace with the desired output file path
