...
output_file = 'BDFB_principal_srf.gff3' # Change this to your desired output file name
...
with open(input_file, 'r') as infile:
    ...
    for row in reader:
        ...
        # Column 4: Start position + 1
        new_row.append(str(start + 1))
        
        # Column 5: End position + 1
        new_row.append(str(end + 1))
