...
file2_path = 'genomes/GCF_963966145.1_icTenMoli1.1_protein.faa'  # Replace with the path to your first file
file1_path = 'TM_BDFB_compRuns1/GCF_963966145.1_icTenMoli1.1_protein/homologs_awk.txt'  # Replace with the path to your second file
output_file_path = 'HomologNamesTM.txt'  # Replace with the desired output file path
